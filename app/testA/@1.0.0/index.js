...
(function () {
  ...
  document.querySelector("#mfspa-root").innerHTML = `<div><div>TestA</div>
    <button id="go-testB" type="button">go testB</button>
  </div>`;

  // document.querySelector("#go-testB").onclick = function (e) {
  //   window.commonRouter.route("/app/testB/module1/page2?id=333&name=test");
  // };

  // const TestAConstant = "testA constant";

  // var testA = "33333333";

  const container = document.querySelector("#mfspa-root");

  const prefix = "/app/testA";

  const routes = [
    {
      path: "/module1/page2",
      callback: function () {
        container.innerHTML = `<div><div>TestA page2</div>
        ...
        const testBBtn = container.querySelector("#go-testB");
        testBBtn.onclick = function (e) {
          routeTo("/app/testB/module1/page2?id=page3");
        };
      },
    },
    {
      path: "/module1/page3",
      callback: function () {
        container.innerHTML = `<div><div>TestA page3</div>
  ...
  window.addHistoryListener("historyChange", function () {
    console.log("testA history change");
